...
TOOLS = [
    ...
    {"name": "send_email", "description": "Send email FROM aria@opustrace.com",
     "input_schema": {"type": "object", "properties": {"to": {"type": "string"}, "subject": {"type": "string"}, "body": {"type": "string"}}, "required": ["to", "subject", "body"]}},
    {"name": "check_email", "description": "Check YOUR inbox (aria@opustrace.com) - returns id, from, subject, body_preview. Use read_email to get full body.",
...
def execute_tool(name: str, args: dict, state_file: Path, state: dict, current_model: str) -> str:
    ...
    if name == "list_files":
        ...
        allowed = ["echo", "date", "cat", "head", "tail", "ls", "mkdir", "cp", "mv", "rm", "find", "grep", "diff", "sort", "python3", "curl", "wget", "tar", "gzip", "base64", "sed", "awk", "pwd", "df", "du", "ps", "openssl", "sha256sum", "git", "ssh-keygen"]
